...
echo 0 1 | gmx pdb2gmx -f polymer.pdb -ff p3ht_gromos_v_2017RA-JACS-stiffer -ter yes -o polymer.gro -p polymer.top

python shift-resnr.py polymer.top polymerout.top

sh top2itp.sh ${no_monomers} header-stiffer

# clean-up
rm polymer.pdb polymer.top polymerout.top posre.itp
mv polymerout.itp p3ht_n${no_monomers}_2017RA-JACS-stiffer.itp
